...
export declare function loadIntegration(ctx: Context, analyticsInstance: Analytics, name: string, version: string, settings?: {
    [key: string]: any;
}, obfuscate?: boolean): Promise<LegacyIntegration>;
