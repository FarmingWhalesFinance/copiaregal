...
export declare type MiddlewareFunction = (middleware: MiddlewareParams) => void;
export declare type DestinationMiddlewareFunction = (middleware: DestinationMiddlewareParams) => void;
