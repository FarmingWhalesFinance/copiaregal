...
export declare class AnalyticsBuffered implements PromiseLike<[Analytics, Context]>, AnalyticsBrowserCore {
    ...
    identify: (id?: object | import("../user").ID, traits?: import("../events").Traits | import("../events").Callback | null | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined) => Promise<Context>;
    reset: () => Promise<void>;
    group: {
        (): Promise<import("../user").Group>;
        (id?: object | import("../user").ID, traits?: import("../events").Traits | import("../events").Callback | null | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined): Promise<Context>;
    };
    track: (eventName: string | import("../events").SegmentEvent, properties?: import("../events").EventProperties | import("../events").Callback | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined) => Promise<Context>;
    ready: (callback?: Function | undefined) => Promise<unknown>;
    alias: (to: string | number, from?: string | number | import("../events").Options | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined) => Promise<Context>;
    debug: (toggle: boolean) => AnalyticsBuffered;
    page: (category?: string | object | undefined, name?: string | object | import("../events").Callback | undefined, properties?: import("../events").Options | import("../events").EventProperties | import("../events").Callback | null | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined) => Promise<Context>;
    once: (event: string, fn: Function) => AnalyticsBuffered;
    off: (event: string, callback: Function) => AnalyticsBuffered;
    on: (event: string, callback: Function) => AnalyticsBuffered;
    ...
    screen: (category?: string | object | undefined, name?: string | object | import("../events").Callback | undefined, properties?: import("../events").Options | import("../events").EventProperties | import("../events").Callback | null | undefined, options?: import("../events").Options | import("../events").Callback | undefined, callback?: import("../events").Callback | undefined) => Promise<Context>;
