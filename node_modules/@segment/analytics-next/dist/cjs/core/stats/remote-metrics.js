...
var RemoteMetrics = /** @class */ (function () {
    ...
    RemoteMetrics.prototype.increment = function (metric, tags) {
        ...
        var type = (0, normalize_1.getVersionType)();
        if (type === 'web') {
            formatted['library_version'] = "next-".concat(version_1.version);
        }
        else {
            formatted['library_version'] = "npm:next-".concat(version_1.version);
        }
        this.queue.push({
            type: 'Counter',
            metric: metric,
    ...
    RemoteMetrics.prototype.send = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, (0, unfetch_1.default)(url, {
                        headers: headers,
