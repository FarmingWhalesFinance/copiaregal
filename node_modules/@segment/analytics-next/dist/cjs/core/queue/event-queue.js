    ...
    EventQueue.prototype.flush = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.queue.length === 0 || !(0, connection_1.isOnline)()) {
                            return [2 /*return*/, []];
                        }
                        ctx = this.queue.pop();
                        if (!ctx) {
            ...
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 5];
                    case 8:
                        (_b = inspector_1.inspectorHost.enriched) === null || _b === void 0 ? void 0 : _b.call(inspector_1.inspectorHost, ctx);
                    ...
                    case 9:
                        ...
                        (_d = inspector_1.inspectorHost.delivered) === null || _d === void 0 ? void 0 : _d.call(inspector_1.inspectorHost, ctx, ['segment.io']);
