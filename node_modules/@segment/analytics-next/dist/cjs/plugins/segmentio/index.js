...
function segmentio(analytics, settings, integrations) {
    ...
    var client = ((_c = settings === null || settings === void 0 ? void 0 : settings.deliveryStrategy) === null || _c === void 0 ? void 0 : _c.strategy) === 'batching'
        ? (0, batched_dispatcher_1.default)(apiHost, (_d = settings === null || settings === void 0 ? void 0 : settings.deliveryStrategy) === null || _d === void 0 ? void 0 : _d.config)
        : (0, fetch_dispatcher_1.default)();
    function send(ctx) {
