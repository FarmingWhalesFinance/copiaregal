                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, delivery_1.attempt)(ctx, xt)];
                                    case 1:
                                        result = _a.sent();
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, (0, loader_1.loadIntegration)(ctx, analyticsInstance, this.name, this.version, this.settings, this.options.obfuscate)];
                    case 1:
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, middleware_1.applyDestinationMiddleware)(this.name, klona(ctx.event), this.middleware)];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, as_promise_1.asPromise)(this.integration.invoke.call(this.integration, eventType, event))];
                    case 3:
                        _c.sent();
                        _c.label = 4;
...
function ajsDestinations(settings, globalIntegrations, options) {
    ...
    var routingMiddleware = (0, routing_middleware_1.tsubMiddleware)(routingRules);
